...
@Config
@Autonomous(name = "RedTouchingWallNineBallslLineHigherBallAuto", group = "Autonomous")
public class RedTouchingWallNineBallsLineHigherBallFirst extends AutoParent {
