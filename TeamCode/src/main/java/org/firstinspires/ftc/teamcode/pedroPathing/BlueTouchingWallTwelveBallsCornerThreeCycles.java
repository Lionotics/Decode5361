...
@Config
@Autonomous(name = "BlueTouchingWallTwelveBallsCornerThreeCyclesAuto", group = "Autonomous")
public class BlueTouchingWallTwelveBallsCornerThreeCycles extends AutoParent {
