...
@Config
@Autonomous(name = "RedTouchingWallNineBallsCornerAuto", group = "Autonomous")
public class RedTouchingWallNineBallsCorner extends AutoParent {
    ...
    public  static  double gettingLowerWallBallY = 10;

    public  static  double gettingHigherWallBallX = 134;

    public  static  double gettingHigherWallBallY = 10;
        ...
        switch (pathState) {
            ...
            case 12:
                ...
                if (!follower.isBusy() || fullFor >= minIntakeMS || totalElapsed >= maxIntakeMS) {
                    Intake.INSTANCE.eat().invoke();
                    follower.breakFollowing();
                    follower.followPath(pathToShootingfromHigherBalls);
                    Outtake.INSTANCE.holdVelocity(holdVelocityBefore).invoke();
