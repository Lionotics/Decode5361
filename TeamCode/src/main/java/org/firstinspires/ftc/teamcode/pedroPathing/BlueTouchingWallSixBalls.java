...
@Config
@Autonomous(name = "BlueTouchingWallSixBallsAuto", group = "Autonomous")
public class BlueTouchingWallSixBalls extends AutoParent {
    ...
    public  static  double gettingLineBallX = 6;
