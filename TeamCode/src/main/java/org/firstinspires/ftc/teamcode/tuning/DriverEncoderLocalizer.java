...
public class DriverEncoderLocalizer implements Localizer {
     ...
     */
    public DriverEncoderLocalizer(HardwareMap map, DriveEncoderConstants constants) {
     ...
     */
    public DriverEncoderLocalizer(HardwareMap map, DriveEncoderConstants constants, Pose setStartPose) {
