...
@Config
@Autonomous(name = "RedTouchingWallTwelveBallsCornerTwoCyclesAndOneVerticalLoadingAuto", group = "Autonomous")
public class RedTouchingWallTwelveBallsCornerTwoCyclesAndOneVerticalLoading extends AutoParent {
    ...
    public  static  double gettingSecondWallBallY = 56;
